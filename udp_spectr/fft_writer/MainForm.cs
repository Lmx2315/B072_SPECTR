...
namespace fft_writer
{
	...
	public partial class MainForm : Form
	{
       ...
       static UInt16 FLAG_BUF_SW = 0;
        ...
        double [] TSAMPL      = new double[BUF_MAX];
        double [] MAG_LOG     = new double[BUF_MAX];
        double [] time_series = new double[BUF_MAX];
        ...
        double[][] MeMi = new double[100][];//массив памяти для сглаживания вывода спектроанализатора
        double[][] MeMq = new double[100][];//массив памяти для сглаживания вывода спектроанализатора
            ...
            while ((true) && (FLAG_THREAD == "start"))
            {
              ...
              //          Debug.WriteLine("fft_array_y[i]:" + fft_array_y[i]);
                   ...
                   */
                    ...
                    if (FLAG_filtr == 1)
                    {
                        filtr_usr2(windowedTimeSeries_i, MeMi, 10);
                        filtr_usr2(windowedTimeSeries_q, MeMq, 10);
                    }

                    if (FLAG_filtr == 2)
                    {
                        filtr_usr2(windowedTimeSeries_i, MeMi, 30);
                        filtr_usr2(windowedTimeSeries_q, MeMq, 30);
                    }
                    */
                    ...
                    if (FLAG_filtr == 1) filtr_usr2(magLog, MeMi, 10);
                    if (FLAG_filtr == 2) filtr_usr2(magLog, MeMq, 30);
